...
export default async function BlogDetailPage({ params }: { params: { slug: string } }) {//gọi tự động khi người dùng truy cập đường dẫn kiểu /blog/[slug].
  const blog = await fetchQuery(api.blogs.GetBlogBySlug, { slug: params.slug });//Gọi hàm GetBlogBySlug để lấy blog theo slug.
