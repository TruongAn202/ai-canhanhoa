      ...
      <div className="border rounded-2xl shadow-xl p-8 bg-white max-w-md mx-auto">
        ...
        <ul className="text-left mb-6 space-y-3">
          <li className="flex items-center gap-2">
            ✅ Truy cập toàn bộ AI cá nhân hóa
          </li>
          <li className="flex items-center gap-2">
            ✅ 500.000 tokens mỗi tháng
          </li>
          <li className="flex items-center gap-2">
            ✅ Hỗ trợ nhanh chóng từ đội ngũ
          </li>
          <li className="flex items-center gap-2">
        ...
        <Button className="cursor-pointer w-full bg-pink-600 text-white font-semibold py-3 rounded-xl hover:bg-pink-600 transition">
          Nâng cấp ngay
        </Button>
      </div>
