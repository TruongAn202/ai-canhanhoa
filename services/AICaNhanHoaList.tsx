export default [
    {
      ...
      sampleQuestions: [
        ...
        "Làm sao để viết email chuyên nghiệp hơn?",
        "Tôi cần một mẫu email giới thiệu công ty, bạn có thể giúp không?"
      ]
    },
    {
      id: 2,
      ...
      sampleQuestions: [
        ...
        "Làm sao để viết tiếng Anh tự nhiên hơn?",
        "Bạn có thể gợi ý cách viết lại câu này không?"
      ]
    },
    {
      id: 3,
      ...
      image: "/baomat.png",
      instruction: "Chỉ trả lời các câu hỏi liên quan đến lập trình.",
      userInstruction: "Chỉ trả lời câu hỏi về lập trình.",
      sampleQuestions: [
        "Làm sao để tối ưu mã JavaScript?",
        "Bạn có thể giải thích thuật toán này không?",
        "Làm sao để debug lỗi này?",
        "Có cách nào cải thiện hiệu suất ứng dụng web không?"
      ]
    },
    {
      id: 4,
      ...
      sampleQuestions: [
        ...
        "Có cách nào để quản lý chi tiêu tốt hơn?",
        "Làm sao để tăng thu nhập thụ động?"
      ]
    },
    {
      id: 5,
      ...
      image: "/dichthuat.png",
      instruction: "Chỉ hỗ trợ dịch thuật và ngữ cảnh của từ ngữ.",
      userInstruction: "Hãy gửi đoạn văn cần dịch hoặc cần giải thích.",
      sampleQuestions: [
        "Bạn có thể dịch đoạn văn này sang tiếng Anh không?",
        "Từ này có nghĩa gì trong ngữ cảnh này?",
        "Làm sao để dịch câu này một cách tự nhiên?",
        "Bạn có thể giúp tôi dịch hợp đồng này không?"
      ]
    },
    {
      id: 6,
      ...
      sampleQuestions: [
        ...
        "Làm sao để cải thiện mối quan hệ với người khác?",
        "Có cách nào để tạo động lực làm việc không?"
      ]
    },
    {
      id: 7,
      ...
      sampleQuestions: [
        ...
        "Tôi nên sử dụng nền tảng nào để quảng cáo sản phẩm?",
        "Làm sao để tăng lượng người theo dõi trên mạng xã hội?"
      ]
    },
    {
      id: 8,
      ...
      sampleQuestions: [
        ...
        "Làm sao để viết nội dung thu hút khách hàng?",
        "Bạn có thể giúp tôi viết một bài PR không?"
      ]
    },
    {
      id: 9,
      ...
      sampleQuestions: [
        ...
        "Màu sắc nào phù hợp cho thương hiệu thực phẩm?",
        "Làm sao để tạo hiệu ứng trong Photoshop?"
      ]
    },
    {
      id: 10,
      ...
      sampleQuestions: [
        ...
        "Tôi có nên uống vitamin hàng ngày không?",
        "Làm thế nào để giảm căng thẳng và mệt mỏi?"
      ]
    }
];
